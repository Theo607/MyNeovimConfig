...
return {
    ...
    config = function()
        ...
        vim.keymap.set("n", "]i", function() require("illuminate").next_reference() end, { desc = "Next occurrence" })
        vim.keymap.set("n", "[i", function() require("illuminate").next_reference(true) end, { desc = "Previous occurrence" })
    end,
}
